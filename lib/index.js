...
const {
  ts2jsonschema
} = require('./ts-2-jsonschema');

const {
  saveReqParams
} = require('./save-req-params');

const typeFileSavePath = './result/api-types';
const jsonFileSavePath = './result/api-json'; // const proxyApiUrl = 'https://beiming.test.haochang.tv/api';
    ...
    modifyResponse(res, proxyRes, function (body) {
      ...
      if (body && Object.keys(body).length) {
        ...
        saveType({
          ...
          // 保存data
          saveJSON(resbodyJsonFilePath, JSON.stringify(body)); // 将interface转jsonschema
