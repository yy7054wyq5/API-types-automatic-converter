...
function getFileContent(typeFilePath, jsonFilePath, schemaFilePath) {
	let jsonContent;
			...
			onProxyRes: (proxyRes, req, res) => {
				...
				modifyResponse(res, proxyRes, function (body) {
					...
					return triggerSaveReqParams().then(() => {
						...
						apiLog(res, 'response');
						const typeContent = json2Interface(body, resbodyTypeName); // body, json, typeContent, oldType, schema
